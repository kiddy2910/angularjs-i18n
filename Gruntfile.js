module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        copy: {
            ...
            build_external_files_js: {
                files: [
                    {
                        src: [ '.' ],
                        dest: '<%= pkg.name %>-adapter.js',
                        cwd: '<%= concat.build_external_files_js.dest %>',
                        expand: true
                    }
                ]
            }
        ...
        concat: {
            ...
            build_external_files_js: {
                ...
                dest: '<%= build_dir %>/<%= pkg.name %>-adapter.js'
            },
        ...
        delta: {
            ...
            jssrc: {
                ...
                tasks: [ 'jshint:src', 'copy:build_src_files_js', 'copy:build_external_files_js' ]
            },
